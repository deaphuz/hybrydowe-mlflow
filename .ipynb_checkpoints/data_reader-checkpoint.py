...
# Data Augmentation by duplicating and slightly modifying existing records
def augment_data(df, num_duplicates=100):
    ...
    for i in range(num_duplicates):
        for index, row in df.iterrows():
            ...
            new_row['POTENTIAL_PRICE'] += np.random.randint(-100, 100)
...
# features_augmented, labels_augmented = smote.fit_resample(features_scaled, labels)
